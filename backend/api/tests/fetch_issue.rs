...
pub async fn fetch_issue(docker: &'static Cli) {
	...
	test.should_fetch_an_issue_given_a_repo_id_issue_number()
		.await
		.expect("should_fetch_an_issue_given_a_repo_id_issue_number");
}
...
impl<'a> Test<'a> {
	...
	async fn should_fetch_an_issue_given_a_repo_id_issue_number(&mut self) -> Result<()> {
		info!("should_fetch_an_issue_given_a_repo_id_issue_number");
		// Given
		let resource = "/api/issues/9511147/212";
		...
		assert_eq!(
			issue,
			"{\"id\":1840630181,\"repo_id\":9511147,\"number\":212,\"title\":\"issue-title\",\"author\":{\"id\":16590657,\"login\":\"PierreOucif\",\"avatar_url\":\"https://avatars.githubusercontent.com/u/16590657?v=4\",\"html_url\":\"https://github.com/PierreOucif\"},\"html_url\":\"https://github.com/repo_onwer_test_1/repo_name_test_1/issues/212\",\"status\":\"OPEN\",\"created_at\":\"2023-08-08T06:11:35Z\",\"updated_at\":\"2023-08-08T06:11:35Z\",\"closed_at\":null,\"comments_count\":0}"
		);
		Ok(())
	}
}
