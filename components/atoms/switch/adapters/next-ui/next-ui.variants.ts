...
export const SwitchNextUiVariants = tv({
  slots: {
    ...
    thumb:
      "h-3 w-3 max-w-3 group-data-[selected=true]:ml-[12px] group-data-[selected]:group-data-[pressed]:ml-[12px] group-data-[pressed=true]:w-3 group-data-[selected=true]:bg-interactions-white-default",
    label: "",
    startContent: "",
    endContent: "",
  },
