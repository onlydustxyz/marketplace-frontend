...
export const selectableTagItemVariants = tv({
  base: cn(
    "od-text-body-xs relative inline-flex h-fit w-fit items-center justify-center gap-1 rounded-lg border border-greyscale-50/8 bg-whiteFakeOpacity-10 px-2 py-1 text-neutral-100",
