...
import FilterSelectAutoCompleteItem from "src/components/New/Filter/FilterSelectedAutoComplete/components/item";
...
export function SelectAutocomplete<T extends TSelectAutocomplete.Item>({
  ...
  const token = Hooks.useRenderTokens(selected, items, tokens);
