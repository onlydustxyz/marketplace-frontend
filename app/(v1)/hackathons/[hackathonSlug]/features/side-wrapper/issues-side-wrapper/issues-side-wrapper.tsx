...
import { HackathonIssuesContext } from "app/(v1)/hackathons/[hackathonSlug]/features/hackathon-issues/context/hackathon-issues.context";
      ...
      {!isXl ? (
        <AnimatePresence>
          {isOpen ? (
            ...
            >
              <Paper size="m" container="2" classNames={{ base: "flex flex-col gap-3 h-auto min-h-full" }}>
                {children}
              </Paper>
            </motion.aside>
          ) : null}
