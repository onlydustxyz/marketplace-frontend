...
import { Slider } from "app/(v1)/ecosystems/[ecosystemSlug]/features/languages/components/slider/slider";
import { FilterCard } from "app/(v1)/ecosystems/components/filter-card/filter-card";
