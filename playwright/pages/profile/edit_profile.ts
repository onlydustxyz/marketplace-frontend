...
export class EditProfilePage {
  ...
  constructor(page: Page) {
    ...
    this.emailVisibility = this.page.getByTestId("visibilityToggle").first();
    this.telegram = this.page.getByTestId("telegram");
    this.telegramVisibility = this.page.getByTestId("visibilityToggle").nth(1);
    this.twitter = this.page.getByTestId("twitter");
    this.twitterVisibility = this.page.getByTestId("visibilityToggle").nth(2);
    this.discord = this.page.getByTestId("discord");
    this.discordVisibility = this.page.getByTestId("visibilityToggle").nth(3);
    this.linkedin = this.page.getByTestId("linkedin");
    this.linkedinVisibility = this.page.getByTestId("visibilityToggle").nth(4);
