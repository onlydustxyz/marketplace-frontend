...
export const CreateProjectDocument = gql`
    mutation createProject($projectName: String!, $telegramLink: Url!, $logoUrl: Url!, $shortDescription: String!, $longDescription: String!, $initialBudget: Int, $hiring: Boolean) {
  createProject(
    name: $projectName
    telegramLink: $telegramLink
    logoUrl: $logoUrl
...
export const UpdateProjectDocument = gql`
    mutation updateProject($projectId: Uuid!, $name: String, $telegramLink: Url, $logoUrl: Url, $shortDescription: String, $longDescription: String, $hiring: Boolean) {
  updateProject(
    id: $projectId
    name: $name
    telegramLink: $telegramLink
