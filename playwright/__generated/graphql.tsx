...
export type UserIdFragment = { __typename?: 'users', id: any };

export type ProjectLeadFragment = { __typename?: 'users', displayName: string, avatarUrl: string, id: any };
...
export const CreateProjectDocument = gql`
    mutation createProject($projectName: String!, $telegramLink: Url!, $logoUrl: Url!, $shortDescription: String!, $longDescription: String!, $initialBudget: Int, $hiring: Boolean, $rank: Int) {
  createProject(
    name: $projectName
    telegramLink: $telegramLink
    logoUrl: $logoUrl
...
export const UpdateProjectDocument = gql`
    mutation updateProject($projectId: Uuid!, $name: String, $telegramLink: Url, $logoUrl: Url, $shortDescription: String, $longDescription: String, $hiring: Boolean, $rank: Int) {
  updateProject(
    id: $projectId
    name: $name
    telegramLink: $telegramLink
