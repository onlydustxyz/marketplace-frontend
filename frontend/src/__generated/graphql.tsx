...
export type MyProjectQuery = { __typename?: 'query_root', projectsByPk: { __typename?: 'Projects', name: string, budgets: Array<{ __typename?: 'Budgets', initialAmount: any, remainingAmount: any }>, projectDetails: { __typename?: 'ProjectDetails', description: string | null, telegramLink: string | null } | null, githubRepo: { __typename?: 'GithubRepoDetails', name: string, owner: string, content: { __typename?: 'Repository', contributors: Array<{ __typename?: 'User', login: string }> } } | null } | null };
