...
export type GithubRepoFieldsForProjectCardFragment = { __typename?: "Repository", name: string, owner: string, contributors: Array<{ __typename?: "User", login: string }> };
...
export type MyProjectQuery = { __typename?: "query_root", projectsByPk: { __typename?: "Projects", name: string, budgets: Array<{ __typename?: "Budgets", initialAmount: any, remainingAmount: any }>, projectDetails: { __typename?: "ProjectDetails", description: string | null, telegramLink: string | null } | null, githubRepo: { __typename?: "Repository", name: string, owner: string, contributors: Array<{ __typename?: "User", login: string }> } } | null };
...
export type ProjectDetailsGithubRepoFieldsFragment = { __typename?: "Repository", name: string, owner: string, readme: { __typename?: "File", content: string }, contributors: Array<{ __typename?: "User", login: string }> };
...
export type GetPublicProjectQuery = { __typename?: "query_root", projectsByPk: { __typename?: "Projects", name: string, projectDetails: { __typename?: "ProjectDetails", description: string | null, telegramLink: string | null } | null, githubRepo: { __typename?: "Repository", name: string, owner: string, readme: { __typename?: "File", content: string }, contributors: Array<{ __typename?: "User", login: string }> } } | null };
...
export type GetUserProjectQuery = { __typename?: "query_root", projectsByPk: { __typename?: "Projects", name: string, budgets: Array<{ __typename?: "Budgets", id: any, initialAmount: any, remainingAmount: any }>, projectDetails: { __typename?: "ProjectDetails", description: string | null, telegramLink: string | null } | null, githubRepo: { __typename?: "Repository", name: string, owner: string, readme: { __typename?: "File", content: string }, contributors: Array<{ __typename?: "User", login: string }> } } | null };

export type GetProjectsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProjectsQuery = { __typename?: "query_root", projects: Array<{ __typename?: "Projects", id: any, name: string, projectDetails: { __typename?: "ProjectDetails", description: string | null, telegramLink: string | null } | null, githubRepo: { __typename?: "Repository", name: string, owner: string, contributors: Array<{ __typename?: "User", login: string }> } }> };
...
/**
 * __useGetUsersForPaymentFormQuery__
 *
 * To run a query within a React component, call `useGetUsersForPaymentFormQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersForPaymentFormQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsersForPaymentFormQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetUsersForPaymentFormQuery(baseOptions?: Apollo.QueryHookOptions<GetUsersForPaymentFormQuery, GetUsersForPaymentFormQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUsersForPaymentFormQuery, GetUsersForPaymentFormQueryVariables>(GetUsersForPaymentFormDocument, options);
      }
export function useGetUsersForPaymentFormLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUsersForPaymentFormQuery, GetUsersForPaymentFormQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUsersForPaymentFormQuery, GetUsersForPaymentFormQueryVariables>(GetUsersForPaymentFormDocument, options);
        }
export type GetUsersForPaymentFormQueryHookResult = ReturnType<typeof useGetUsersForPaymentFormQuery>;
