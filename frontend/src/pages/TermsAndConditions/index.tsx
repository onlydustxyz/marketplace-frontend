        ...
        <div className="w-1/2 my-16">
          {!showTermsAndConditions ? (
            ...
            <>
              {!data && (
                <Card
                  className="flex flex-col justify-between gap-7 items-center pt-20 mb-5 divide-y divide-greyscale-50/12"
                  padded={false}
                >
                    ...
                    <Section title="Your commitments">
                      <div className="text-sm pt-3">
                        ...
                        <p>
                          ...
                          You must also decide the amount of funds that You want to allocate to each of the contributors
                          that You manage. If You act for a company, you must comply with additional requirements so
                    ...
                    <Section title="Our responsibilities">
                      <div className="text-sm pt-3">
                        ...
                        <ul className="list-disc ml-6 mb-4">
                          ...
                          <li>
                            Transfer You the funds that have been attributed to You by the community, upon reporting of
                            Your developments on the platform.
                          </li>
                        </ul>
                        ...
                        <ul className="list-disc ml-6 mb-4">
                          ...
                          <li>
                            ...
                            stops the funding of a project that You are a part of, we will inform You that the Terms and
