...
const TermsAndConditionsPromptCard = ({ setShowTermsAndConditions }: TermsAndConditionsPromptCardProps) => (
  <Card className="flex flex-col justify-between gap-7 items-center px-24 pt-20 pb-12 relative mx-auto" padded={false}>
