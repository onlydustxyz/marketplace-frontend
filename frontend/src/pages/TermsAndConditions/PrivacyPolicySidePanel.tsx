      ...
      <div className="px-6 py-6 font-walsheim overflow-y-auto  scrollbar-thin scrollbar-w-2 scrollbar-thumb-spaceBlue-500 scrollbar-thumb-rounded">
        <Card className="bg-noise-heavy">
          ...
          <p className="text-md mb-3">
            Onlydust.xyz is an online service edited by Wagmi SAS, a French simplified joint stock company registered in
            the trade and companies register of Paris under number 908 233 638, headquartered at 34 rue des Bourdonnais,
            75001 Paris, France.
          </p>
          <p className="text-md mb-3">
        ...
        <div>
          ...
          <table>
            <tr>
              <td>Account</td>
              <td>
                refers to a User’s dedicated and individualized digital interface on the Platform and granting access to
                the Services.
              </td>
            </tr>
            <tr>
        ...
        <div>
          ...
          <Paragraph>
            ...
            debug, and conduct research on the performance of Our Platform and You use of the Service:
            <List>
          ...
          <Paragraph>
            ...
            <List>
              ...
              <li>
                Amazon Web Services and Heroku for Data storage. For this purpose we share the following Personal Data:
                all Data listed in section 3. For more information on those providers, You can consult:
              </li>
              <List>
          ...
          <Paragraph>
            ...
            <List>
              ...
              <li>
                All persons with access to Your Personal Data are bound by a duty of confidentiality and may be subject
                to disciplinary action and/or other sanctions if they fail to comply with these obligations;
              </li>
              <li>
