  ...
  return (
    <div className="flex h-full min-h-0 w-full bg-greyscale-900 px-4 md:rounded-3xl">
      <div className="flex min-h-0 w-full flex-col gap-4 lg:flex-row lg:divide-x lg:divide-greyscale-50/8">
        <div className="flex flex-col py-4 lg:basis-1/2 lg:overflow-y-auto">
          <Header
        ...
        <div className="flex flex-col gap-12 px-px py-4 lg:basis-1/2 lg:overflow-y-auto lg:pl-8 lg:pr-4">
          <StatsSection
            profile={profile}
