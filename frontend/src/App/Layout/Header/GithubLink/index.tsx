  ...
  return (
    <a className="z-10" href={LOGIN_URL} onClick={onClick} data-testid="github-signin-button">
      <div className="m-px w-fit overflow-hidden rounded-full p-px blur-0 transition duration-300 hover:m-0 hover:p-0.5">
        <div className="relative flex w-fit items-center justify-center rounded-full bg-black before:absolute before:-z-10 before:h-screen before:w-screen before:bg-multi-color-gradient hover:bg-spacePurple-900 hover:before:animate-spin-invert-slow">
