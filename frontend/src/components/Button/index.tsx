  ...
  return (
    <button
      className={classNames(
        ...
        {
          "mh-14 gap-3 rounded-xl": size === ButtonSize.Lg,
          "mh-12 gap-3 rounded-xl": size === ButtonSize.LgLowHeight,
          "mh-11 gap-3 rounded-full": size === ButtonSize.LgRounded,
          "mh-12 gap-2 rounded-xl text-base": size === ButtonSize.Md,
          "mh-11 gap-2 rounded-full": size === ButtonSize.MdRounded,
          "mh-8 gap-2 rounded-large text-sm": size === ButtonSize.Sm,
          "mh-6 gap-1 rounded-lg text-xs": size === ButtonSize.Xs,
        },
        !iconOnly && {
        ...
        iconOnly && {
          "mh-14 w-14 p-4": size === ButtonSize.Lg,
          "mh-12 w-12 p-3.5": size === ButtonSize.LgLowHeight || size === ButtonSize.Md,
          "mh-8 w-8 p-2": size === ButtonSize.Sm,
          "mh-6 w-6 p-1": size === ButtonSize.Xs,
        }
      )}
      type={htmlType}
      disabled={disabled}
