          ...
          <Card className="flex flex-col gap-3 divide-y divide-greyscale-50/8" selectable>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="text-sm text-spaceBlue-200">
            ...
            <div className="flex gap-4 divide-x divide-greyscale-50/8 pt-3 font-walsheim text-sm">
              <div className="flex w-1/2 flex-col items-start">
                ...
                {formatMoneyAmount({ amount: payment.amount.value, currency: payment.amount.currency })}
              </div>
              ...
              <div className="flex flex-col items-start pl-4">
                ...
                {displayRelativeDate(payment.requestedAt)}
              </div>
            </div>
          </Card>
        </button>
