      ...
      <div className="mr-1 flex h-full min-h-0 flex-col  gap-7 divide-y divide-greyscale-50/12  overflow-y-auto pl-6 pr-5 scrollbar-thin scrollbar-thumb-white/12 scrollbar-thumb-rounded scrollbar-w-1.5">
        ...
        <div className="py-6 font-walsheim">
          ...
          <div>
            ...
            <Paragraph>
              <ParagraphNumber num={8} /> During this period, Users may terminate the T&Cs by any means provided that
              they complete any commitment to which they have already agreed.
            </Paragraph>
            ...
            <Paragraph>
              ...
              <ol>
                <li>
                  ...
                  natural person who does not have full legal capacity may only access the Platform and the Services
            ...
            <Paragraph>
              ...
              entity acknowledges that he/she is authorized to do so. The legal entity may in no case be released from
              its obligations on the grounds that the natural person did not have the authority to commit
              himself/herself.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              <ParagraphNumber num={12} /> Wagmi operates the Platform, a digital infrastructure aiming at optimizing
              the funding of open source Projects. The role of Wagmi is limited to the operation of the Platform, the
            ...
            <Paragraph>
              <ParagraphNumber num={16} /> Based on the decision of the Community, Wagmi will allocate a minimum amount
              of Grants to Projects. If the first amount of Grants allocated is not sufficient to finalize the Project,
              the Community will be consulted and will decide whether or not to allocate a second amount of Grants.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              <ParagraphNumber num={18} /> Wagmi is not responsible for the amounts of Grants allocated for each
              Project. The decision of the Community not to reallocate Grants may not give rise to any compensation
              whatsoever by Wagmi to Contributors.
            </Paragraph>
            ...
            <Paragraph>
              <ParagraphNumber num={25} /> In particular, unless otherwise provided by law or regulation, Wagmi shall
            ...
            <Paragraph>
              ...
              <List>
                ...
                <li>
                  that they are of legal age or have obtain a legal representative authorisation and supervision and
                  have the capacity to enter into an agreement with Wagmi and as the case may be with other Users, in
                ...
                <li>
                  ...
                  Platform and the Services, to keep this information up-to-date throughout their time using the
                  Platform and the Services and to publish content that meets these same requirements;
                </li>
            ...
            <Paragraph>
              ...
              from a professional in his field or from a duly responsible person and to comply with the customs in
              force.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              <ParagraphNumber num={30} /> Users undertake to Report their time passed on the development of a Project
              on the Platform.
            </Paragraph>
            ...
            <Paragraph>
              <ParagraphNumber num={32} /> They are also responsible for complying with the regulations applicable to
              the contractual relationship to which they are a party.
            </Paragraph>
            ...
            <Paragraph>
              ...
              administrative, fiscal and social formalities and for all payments of contributions, taxes or duties of
              any kind that they are responsible for, where applicable, in connection with their use of the Services.
            </Paragraph>
            <SectionTitle num={7} title="Liability" />
            <SectionSubTitle num={7} subNum={1} title="Wagmi's liability" />
            <Paragraph>
              <ParagraphNumber num={37} /> Unless otherwise provided by law, where Wagmi’s liability may be established
              by Users, taking into account the free nature of the Services, Wagmi’s liability will not exceed 500
              Euros. For residents of the European Union, consumer rules may contain more favorable provisions, in which
              case such provisions will apply.
            </Paragraph>
            <Paragraph>
              ...
              other damages and losses suffered by the User, in particular indirect damages (including but not limited
              to, earning or profit losses, commercial damages, the consequences of complaints, actions, claims of third
            ...
            <Paragraph>
              ...
              The User guarantees Wagmi against any complaints, claims, actions and/or demands that Wagmi may suffer as
              a result of the User&apos;s breach of any of his/her obligations under these T&Cs. The User undertakes to
              indemnify Wagmi for any damage suffered as a result of such a breach.
            </Paragraph>
            <SectionTitle num={8} title="Duration, suspension and termination" />
            <SectionSubTitle num={8} subNum={1} title="Duration" />
            <Paragraph>
              <ParagraphNumber num={40} /> The T&Cs are entered into for an indefinite term. The T&Cs shall stay in
              force as long as the User accesses and use the Platform or the Services.
            </Paragraph>
            ...
            <Paragraph>
              ...
              After an investigation period during which Wagmi shall verify the truth of the alleged violations, access
              to the Platform and/or to the Services may be restored or the T&Cs may be terminated in accordance with
              the terms below.
            </Paragraph>
            <SectionSubTitle num={8} subNum={3} title="Termination" />
            <Paragraph>
              <ParagraphNumber num={43} /> Users may terminate these T&Cs at any time by sending an email to the
              following email address: <a href="mailto:admin@onlydust.xyz">admin@onlydust.xyz</a>. After doing so, Users
              shall not access the Platform and use the Services, unless they accept the T&Cs again.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              <ParagraphNumber num={45} /> Without prejudice to any other action, Wagmi may terminate these T&Cs and
              block the User’s access to the Platform in case of material breach of these T&Cs and in particular in case
              of a breach of the sections entitled “Commitments” and “Intellectual Property”.
            </Paragraph>
            <Paragraph>
              <ParagraphNumber num={46} /> Moreover, if the Partners decide to stop the allocation of Grants to
              Projects, the T&Cs will automatically end for all Contributors and Project Leaders involved in such
              Projects.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              ...
              or resources, which may be subject to different policies. Wagmi is not responsible for the content
              available through such links.
            </Paragraph>
            ...
            <Paragraph>
              ...
              content generated by Wagmi are Wagmi&apos;s sole intellectual property and are protected by all
            ...
            <Paragraph>
              ...
              universal transfer of Wagmi’s assets or (ii) any operation entailing a direct or indirect change of
              control affecting Wagmi, the contractual relations will persist without it being necessary to inform or
            ...
            <Paragraph>
              <ParagraphNumber num={55} /> All complaints, disputes or claims about the relation to other Contributors
              or Lead Projects should be directed to such a person.
            </Paragraph>
            ...
            <Paragraph>
              ...
              French conflict-of-law rules. For residents of the European Union, consumer rules may contain more
              favorable provisions, in which case such provisions will apply.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              ...
              validity, the interpretation, performance, and/or termination of the T&Cs must be submitted to the
              exclusive jurisdiction of the Paris courts.
            </Paragraph>
            <Paragraph>
              <ParagraphNumber num={60} /> Non-professional EU residents may submit any dispute related to the T&Cs in
              the jurisdiction where they were living at the moment of the acceptance of the T&Cs or in the jurisdiction
