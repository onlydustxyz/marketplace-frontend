...
import {
  ...
  calculateUserCompletionScore,
} from "./calculateCompletionScore";

describe("calculateUserCompletionScore", () => {
  it("should return the correct completion score", () => {
    ...
    const completionScore = calculateUserCompletionScore(userProfile);
  ...
  it("should return the correct completion score", () => {
    ...
    const expectedScore =
      ...
      20 + // bio exists
      10 + // website exists
      5 + // EMAIL contact does not exist
      5 + // TELEGRAM contact does not exist
      0 + // WHATSAPP contact does not exist
      5 + // TWITTER contact does not exist
      0 + // DISCORD contact does not exist
      5 + // LINKEDIN contact exists
      10; // technologies exist
