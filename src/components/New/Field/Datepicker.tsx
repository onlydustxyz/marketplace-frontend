      ...
      {({ open, close: closeMain }) => (
        <>
          <Popover.Button
            ...
            className={cn(
              "relative right-0 flex w-full origin-right items-center gap-6 rounded-lg border border-greyscale-50/8 bg-white/5 px-2.5 py-1.5 shadow-lg transition-all duration-200 ease-out",
              {
